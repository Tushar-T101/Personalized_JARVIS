...
#     sleep(5)
#     pyautogui.click(x=1774, y=66)
#     sleep(2)
#     pyautogui.click(x=1543, y=245)
#     sleep(2)
#     pyautogui.click(x=1479, y=105)
#     sleep(2)
...
# def MainExecution(question, chat_log=None):
...
#             answer = str(bard.get_answer(question)['content'])
