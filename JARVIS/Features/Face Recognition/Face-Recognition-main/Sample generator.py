...
#Haar Cascade classifier is an effective object
#  detection approach
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("C:\D\Sem 7\Minor Project\JARVIS\Features\Face Recognition\Face-Recognition-main\samples/sample_" + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
