...
chrome_options.headless = False  # chrome will open but won't be visible
# chrome_options.binary_location = r"C:\Users\tusha\AppData\Local\Google\chrome-win64\chrome.exe"
Path = "Database\\chromedriver.exe"
driver = webdriver.Chrome(Path, options=chrome_options)
driver.maximize_window()  # to maximize chrome window in background
